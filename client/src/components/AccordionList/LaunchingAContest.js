...
- If you choose the Gold package or Platinum package and keep the contest as 'Not Guaranteed', you can request a partial refund if you choose not to move forward with any name from you project. (Please note that the refund is for the contest award). Here is a link to our [Refund Policy](https://helpdesk.squadhelp.com/en/articles/115621-refund-policy)`
  },
  {
    question: "How much does it cost?",
    answer: `Our naming competitions start at $299, and our logo design competitions start at $299. Also, there are three additional contest level that each offer more features and benefits. See our [Pricing Page](https://www.squadhelp.com/squadhelp-pricing) for details`
  },
  {
    question: "I need both a Name and a Logo. Do you offer any discount for multiple contests?",
    answer: `Yes! We have many contest bundles - our most popular being our Name, Tagline, and Logo bundle. Bundles allow you to purchase multiple contests at one time and save as much as from $75 - $400. You can learn more about our bundle options on our [Pricing Page](https://www.squadhelp.com/squadhelp-pricing)`
  },
  {
...
* [Name Examples](https://www.squadhelp.com/business-name-generator) 
* [Tagline Examples](https://www.squadhelp.com/tagline-slogan-ideas) 
* [Logo Examples](https://www.squadhelp.com/logo-design-examples)`
  }
]

export default launchingAContest