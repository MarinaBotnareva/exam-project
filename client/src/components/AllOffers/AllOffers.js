...
const AllOffers = (props) => {
  ...
  const offerApprovement = () => {
    ...
    if (approved === true) {
      return (
        <i
          className={classNames('fas fa-check-circle resolve', styles.approved)}
        />
      );
    }
    return null;
    ...
    <div className={styles.offerContainer}>
      ...
      <div className={styles.mainInfoContainer}>
        <div className={styles.userInfo}>
          ...
          <div className={styles.creativeRating}></div>
        </div>
      ...
      {data.approved === null && (
        <div className={styles.btnsContainer}>
          ...
          <div onClick={disaproveOffer} className={styles.disapproveBtn}>
            Disapprove
          </div>
        </div>
      )}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(AllOffers),
);
